!function(t) {
    function i(i, e) {
        function l(i, e) {
            ...
            e ? 0 === l ? (h.$slideTitles.find("li:eq(" + (h.slideCount - 1) + ")").attr("class", "title--auto title--right"),
            h.$slideTitles.find("li:eq(" + l + ")").attr("class", "title--active title--auto")) : (h.$slideTitles.find("li:eq(" + (l - 1) + ")").attr("class", e ? "title--right title--auto" : "title--right"),
            h.$slideTitles.find("li:eq(" + l + ")").attr("class", e ? "title--active title--auto" : "title--active")) : h.$slideTitles.find("li:eq(" + l + ")").attr("class", "title--active"),
            h.$el.offset().height
        }
        function s() {
            var t = 0;
        ...
        function u() {
            ...
            h.slideWidth = h.$el.width(),
            h.$slider.attr("style", t + "width: " + h.slideCount * h.slideWidth + "px"),
            h.$slides.width(h.slideWidth + "px")
        }
        function c() {
            var i;
